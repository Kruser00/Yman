...
import { Upload, Download, Sliders, Crop as CropIcon, ImageIcon, X, Plus, Layers, Check, Wand2, ArrowLeft, Zap, ArrowLeftRight, Home } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex flex-col bg-[#050505] overflow-y-auto cool-scrollbar">
      ...
      <header className="h-16 flex items-center justify-between px-4 md:px-6 glass-panel border-b border-l-0 border-r-0 border-t-0 rounded-none z-30 sticky top-0">
         ...
         <div className="flex items-center gap-2 md:gap-4">
            <Link to="/" className="glass-button text-xs md:text-sm !px-3 md:!px-4 flex items-center gap-1.5 hover:bg-cyan-500/20 hover:border-cyan-400 hover:text-cyan-300 transition-colors">
              <Home size={16}/> <span className="hidden md:inline">خانه</span>
            </Link>
